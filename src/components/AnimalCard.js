...
function AnimalCard(props) {
  ...
  return (
    <div className="card h-100">
      <div className="our-card-top position-relative">
        {isEditing && (
          <div className="our-custom-input">
            <div className="our-custom-input-interior bg-danger position-absolute top-50 start-50 translate-middle">
              <input
              ...
              <>
                ...
                <button
                  onClick={async () => {
                    ...
                    props.setAnimals(prev => {
                      return prev.filter(animal => animal._id != props.id);
                    });
                  }}
